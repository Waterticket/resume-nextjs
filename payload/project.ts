  ...
  list: [
    {
      ...
      descriptions: [
        ...
        {
          content:
            '타사의 MDM 프로그램과 비교하여 다양한 기능과 저렴한 가격으로 윈백에 성공함.',
          descriptions: [
    ...
    },
    {
      ...
      where: '감자소프트',
      descriptions: [
        { content: '래플 모듈 : 커뮤니티 내에서 경품 응모 및 추첨을 위한 모듈. Hotopay와 연동하여 결제시에 응모가능한 기능 존재.' },
        { content: '광고집행 모듈 : 정적 캐시와 Mysql DB를 활용하여 일반 사용자가 사이트에 광고를 올릴 수 있음.' },
        { content: '미션 모듈 : 커뮤니티에서 글을 쓰거나 댓글을 다는 등 활동을 하면 설정해둔 포인트를 지급해줌.' },
        { content: '길드 모듈 : 커뮤니티 내에서 길드 시스템을 구현하여 길드원 관리 및 포인트 소모 컨텐츠를 추가함.' },
      ],
    },
  ],
};
